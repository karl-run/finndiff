...
describe('merger', () => {
  it('when a single value has changed it should return a correct truth object', () => {
  ...
  it('when a single property has been added it should return a correct truth object', () => {
  ...
  it('when a property has been added and a property has been changed it should return a correct truth object', () => {
  ...
  it('when a single property has been removed it should return a correct truth object', () => {
  ...
  it('when a property has been added, a property has been changed and one has been removed it should return a correct truth object', () => {
  ...
  it('a created truth object cleaned of null values should have no diff with a correct fresh listing.', () => {
    const result = merger.createTruth([listingFull, listingOneAdded, listingOneChanged, listingOneRemoved]);
